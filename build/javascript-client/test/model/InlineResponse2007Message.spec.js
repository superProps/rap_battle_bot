...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.InlineResponse2007Message();
  });
  ...
  describe('InlineResponse2007Message', function() {
    it('should create an instance of InlineResponse2007Message', function() {
      // uncomment below and update the code to test InlineResponse2007Message
      //var instane = new MusixmatchApi.InlineResponse2007Message();
      //expect(instance).to.be.a(MusixmatchApi.InlineResponse2007Message);
    });
