...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.InlineResponse200Message();
  });
  ...
  describe('InlineResponse200Message', function() {
    it('should create an instance of InlineResponse200Message', function() {
      // uncomment below and update the code to test InlineResponse200Message
      //var instane = new MusixmatchApi.InlineResponse200Message();
      //expect(instance).to.be.a(MusixmatchApi.InlineResponse200Message);
    });
