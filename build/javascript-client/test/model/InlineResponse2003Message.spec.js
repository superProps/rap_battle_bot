...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.InlineResponse2003Message();
  });
  ...
  describe('InlineResponse2003Message', function() {
    it('should create an instance of InlineResponse2003Message', function() {
      // uncomment below and update the code to test InlineResponse2003Message
      //var instane = new MusixmatchApi.InlineResponse2003Message();
      //expect(instance).to.be.a(MusixmatchApi.InlineResponse2003Message);
    });
