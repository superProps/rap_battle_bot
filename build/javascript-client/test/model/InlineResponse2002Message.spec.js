...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.InlineResponse2002Message();
  });
  ...
  describe('InlineResponse2002Message', function() {
    it('should create an instance of InlineResponse2002Message', function() {
      // uncomment below and update the code to test InlineResponse2002Message
      //var instane = new MusixmatchApi.InlineResponse2002Message();
      //expect(instance).to.be.a(MusixmatchApi.InlineResponse2002Message);
    });
