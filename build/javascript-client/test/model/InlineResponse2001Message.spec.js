...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.InlineResponse2001Message();
  });
  ...
  describe('InlineResponse2001Message', function() {
    it('should create an instance of InlineResponse2001Message', function() {
      // uncomment below and update the code to test InlineResponse2001Message
      //var instane = new MusixmatchApi.InlineResponse2001Message();
      //expect(instance).to.be.a(MusixmatchApi.InlineResponse2001Message);
    });
