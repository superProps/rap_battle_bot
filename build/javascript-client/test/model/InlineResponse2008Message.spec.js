...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.InlineResponse2008Message();
  });
  ...
  describe('InlineResponse2008Message', function() {
    it('should create an instance of InlineResponse2008Message', function() {
      // uncomment below and update the code to test InlineResponse2008Message
      //var instane = new MusixmatchApi.InlineResponse2008Message();
      //expect(instance).to.be.a(MusixmatchApi.InlineResponse2008Message);
    });
