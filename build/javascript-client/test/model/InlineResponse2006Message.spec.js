...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.InlineResponse2006Message();
  });
  ...
  describe('InlineResponse2006Message', function() {
    it('should create an instance of InlineResponse2006Message', function() {
      // uncomment below and update the code to test InlineResponse2006Message
      //var instane = new MusixmatchApi.InlineResponse2006Message();
      //expect(instance).to.be.a(MusixmatchApi.InlineResponse2006Message);
    });
