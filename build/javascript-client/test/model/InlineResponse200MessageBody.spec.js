...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.InlineResponse200MessageBody();
  });
  ...
  describe('InlineResponse200MessageBody', function() {
    it('should create an instance of InlineResponse200MessageBody', function() {
      // uncomment below and update the code to test InlineResponse200MessageBody
      //var instane = new MusixmatchApi.InlineResponse200MessageBody();
      //expect(instance).to.be.a(MusixmatchApi.InlineResponse200MessageBody);
    });
