...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.InlineResponse200MessageHeader();
  });
  ...
  describe('InlineResponse200MessageHeader', function() {
    it('should create an instance of InlineResponse200MessageHeader', function() {
      // uncomment below and update the code to test InlineResponse200MessageHeader
      //var instane = new MusixmatchApi.InlineResponse200MessageHeader();
      //expect(instance).to.be.a(MusixmatchApi.InlineResponse200MessageHeader);
    });
