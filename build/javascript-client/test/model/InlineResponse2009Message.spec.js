...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.InlineResponse2009Message();
  });
  ...
  describe('InlineResponse2009Message', function() {
    it('should create an instance of InlineResponse2009Message', function() {
      // uncomment below and update the code to test InlineResponse2009Message
      //var instane = new MusixmatchApi.InlineResponse2009Message();
      //expect(instance).to.be.a(MusixmatchApi.InlineResponse2009Message);
    });
