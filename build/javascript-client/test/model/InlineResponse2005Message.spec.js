...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.InlineResponse2005Message();
  });
  ...
  describe('InlineResponse2005Message', function() {
    it('should create an instance of InlineResponse2005Message', function() {
      // uncomment below and update the code to test InlineResponse2005Message
      //var instane = new MusixmatchApi.InlineResponse2005Message();
      //expect(instance).to.be.a(MusixmatchApi.InlineResponse2005Message);
    });
