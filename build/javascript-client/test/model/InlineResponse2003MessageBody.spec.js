...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.InlineResponse2003MessageBody();
  });
  ...
  describe('InlineResponse2003MessageBody', function() {
    it('should create an instance of InlineResponse2003MessageBody', function() {
      // uncomment below and update the code to test InlineResponse2003MessageBody
      //var instane = new MusixmatchApi.InlineResponse2003MessageBody();
      //expect(instance).to.be.a(MusixmatchApi.InlineResponse2003MessageBody);
    });
