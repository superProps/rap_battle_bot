...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse200MessageBody', 'model/InlineResponse200MessageHeader'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse200MessageBody'), require('./InlineResponse200MessageHeader'));
  } else {
    // Browser globals (root is window)
    if (!root.MusixmatchApi) {
      root.MusixmatchApi = {};
    }
    root.MusixmatchApi.InlineResponse200Message = factory(root.MusixmatchApi.ApiClient, root.MusixmatchApi.InlineResponse200MessageBody, root.MusixmatchApi.InlineResponse200MessageHeader);
  }
}(this, function(ApiClient, InlineResponse200MessageBody, InlineResponse200MessageHeader) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('body')) {
        obj['body'] = InlineResponse200MessageBody.constructFromObject(data['body']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse200MessageBody} body
   */
