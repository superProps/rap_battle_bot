...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2009Message'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2009Message'));
  } else {
    // Browser globals (root is window)
    if (!root.MusixmatchApi) {
      root.MusixmatchApi = {};
    }
    root.MusixmatchApi.InlineResponse2009 = factory(root.MusixmatchApi.ApiClient, root.MusixmatchApi.InlineResponse2009Message);
  }
}(this, function(ApiClient, InlineResponse2009Message) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('message')) {
        obj['message'] = InlineResponse2009Message.constructFromObject(data['message']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse2009Message} message
   */
