...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2001Message'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2001Message'));
  } else {
    // Browser globals (root is window)
    if (!root.MusixmatchApi) {
      root.MusixmatchApi = {};
    }
    root.MusixmatchApi.InlineResponse2001 = factory(root.MusixmatchApi.ApiClient, root.MusixmatchApi.InlineResponse2001Message);
  }
}(this, function(ApiClient, InlineResponse2001Message) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('message')) {
        obj['message'] = InlineResponse2001Message.constructFromObject(data['message']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse2001Message} message
   */
