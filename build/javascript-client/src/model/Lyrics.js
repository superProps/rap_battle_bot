...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MusixmatchApi.Lyrics = factory(root.MusixmatchApi.ApiClient);
  }
   ...
   */
  exports.prototype['pixel_tracking_url'] = undefined;
  /**
   * @member {Array.<String>} publisher_list
   */
  exports.prototype['publisher_list'] = undefined;
  /**
   * 
   * @member {String} lyrics_language_description
   */
  exports.prototype['lyrics_language_description'] = undefined;
  /**
   * 
   ...
   */
  exports.prototype['lyrics_copyright'] = undefined;
  /**
   * 
   * @member {String} html_tracking_url
   */
  exports.prototype['html_tracking_url'] = undefined;
  /**
   * 
   * @member {String} lyrics_language
   */
  exports.prototype['lyrics_language'] = undefined;
  /**
   * 
   * @member {String} script_tracking_url
   */
  exports.prototype['script_tracking_url'] = undefined;
  /**
   * 
   ...
   */
  exports.prototype['lyrics_body'] = undefined;
  /**
   * 
   ...
   */
  exports.prototype['writer_list'] = undefined;
  /**
   * 
   * @member {Number} can_edit
   */
  exports.prototype['can_edit'] = undefined;
  /**
   * 
   * @member {String} action_requested
   */
  exports.prototype['action_requested'] = undefined;
  /**
   * 
