...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2004Message'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2004Message'));
  } else {
    // Browser globals (root is window)
    if (!root.MusixmatchApi) {
      root.MusixmatchApi = {};
    }
    root.MusixmatchApi.InlineResponse2004 = factory(root.MusixmatchApi.ApiClient, root.MusixmatchApi.InlineResponse2004Message);
  }
}(this, function(ApiClient, InlineResponse2004Message) {
  'use strict';
