...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MusixmatchApi.InlineResponse2008MessageBody = factory(root.MusixmatchApi.ApiClient, root.MusixmatchApi.Subtitle);
  }
  ...
  /**
   * The InlineResponse2008MessageBody model module.
   * @module model/InlineResponse2008MessageBody
   * @version 1.1.0
   */

  /**
   * Constructs a new <code>InlineResponse2008MessageBody</code>.
   * @alias module:model/InlineResponse2008MessageBody
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2008MessageBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2008MessageBody} obj Optional instance to populate.
   * @return {module:model/InlineResponse2008MessageBody} The populated <code>InlineResponse2008MessageBody</code> instance.
   */
