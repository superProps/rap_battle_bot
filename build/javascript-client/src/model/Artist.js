...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ArtistArtistAliasList', 'model/ArtistArtistCredits', 'model/ArtistArtistNameTranslationList', 'model/ArtistPrimaryGenres', 'model/ArtistSecondaryGenres'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ArtistArtistAliasList'), require('./ArtistArtistCredits'), require('./ArtistArtistNameTranslationList'), require('./ArtistPrimaryGenres'), require('./ArtistSecondaryGenres'));
  } else {
    // Browser globals (root is window)
    if (!root.MusixmatchApi) {
      root.MusixmatchApi = {};
    }
    root.MusixmatchApi.Artist = factory(root.MusixmatchApi.ApiClient, root.MusixmatchApi.ArtistArtistAliasList, root.MusixmatchApi.ArtistArtistCredits, root.MusixmatchApi.ArtistArtistNameTranslationList, root.MusixmatchApi.ArtistPrimaryGenres, root.MusixmatchApi.ArtistSecondaryGenres);
  }
}(this, function(ApiClient, ArtistArtistAliasList, ArtistArtistCredits, ArtistArtistNameTranslationList, ArtistPrimaryGenres, ArtistSecondaryGenres) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('artist_alias_list')) {
        obj['artist_alias_list'] = ApiClient.convertToType(data['artist_alias_list'], [ArtistArtistAliasList]);
      }
      ...
      if (data.hasOwnProperty('artist_name_translation_list')) {
        obj['artist_name_translation_list'] = ApiClient.convertToType(data['artist_name_translation_list'], [ArtistArtistNameTranslationList]);
      }
      ...
      if (data.hasOwnProperty('primary_genres')) {
        obj['primary_genres'] = ArtistPrimaryGenres.constructFromObject(data['primary_genres']);
      }
   ...
   */
  exports.prototype['artist_credits'] = undefined;
  /**
   * 
  ...
  /**
   * @member {Array.<module:model/ArtistArtistAliasList>} artist_alias_list
   */
  exports.prototype['artist_alias_list'] = undefined;
  /**
   * 
   * @member {String} artist_vanity_id
   */
  exports.prototype['artist_vanity_id'] = undefined;
  /**
   * 
   ...
   */
  exports.prototype['artist_country'] = undefined;
  /**
   * 
   * @member {String} artist_comment
   */
  exports.prototype['artist_comment'] = undefined;
  /**
   * @member {Array.<module:model/ArtistArtistNameTranslationList>} artist_name_translation_list
   */
  exports.prototype['artist_name_translation_list'] = undefined;
  /**
   * 
   * @member {String} artist_edit_url
   */
  exports.prototype['artist_edit_url'] = undefined;
  /**
   * 
   * @member {String} artist_share_url
   */
  exports.prototype['artist_share_url'] = undefined;
  /**
   * 
  ...
  /**
   * @member {module:model/ArtistPrimaryGenres} primary_genres
   */
   ...
   */
  exports.prototype['artist_twitter_url'] = undefined;
  /**
   * 
   * @member {Number} artist_rating
   */
  exports.prototype['artist_rating'] = undefined;
