...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2005Message'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2005Message'));
  } else {
    // Browser globals (root is window)
    if (!root.MusixmatchApi) {
      root.MusixmatchApi = {};
    }
    root.MusixmatchApi.InlineResponse2005 = factory(root.MusixmatchApi.ApiClient, root.MusixmatchApi.InlineResponse2005Message);
  }
}(this, function(ApiClient, InlineResponse2005Message) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('message')) {
        obj['message'] = InlineResponse2005Message.constructFromObject(data['message']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse2005Message} message
   */
