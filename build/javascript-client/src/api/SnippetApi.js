...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MusixmatchApi.SnippetApi = factory(root.MusixmatchApi.ApiClient, root.MusixmatchApi.InlineResponse20010);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.trackSnippetGetGet = function(trackId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'trackId' is set
      if (trackId == undefined || trackId == null) {
        throw "Missing the required parameter 'trackId' when calling trackSnippetGetGet";
      }
